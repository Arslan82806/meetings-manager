...
class Clientinsta extends StatefulWidget {
  final String user;

  const Clientinsta({Key key, this.user}) : super(key: key);
  @override
  _ClientinstaState createState() => _ClientinstaState();
}

class _ClientinstaState extends State<Clientinsta> {
  String insta;
  bool meeting = false;
