import 'package:meetings_manager/Screens/Clientfacebookupdate..dart';
import 'package:meetings_manager/Screens/Clientskypeupdate..dart';
import 'package:meetings_manager/Screens/clientinstaupdate..dart';
...
import 'package:meetings_manager/Screens/zoomclientupdate.dart';
import 'package:meetings_manager/Screens/zoommeetingupdate..dart';
...
import 'package:meetings_manager/Screens/instaupdate.dart';
import 'package:meetings_manager/Screens/facebookupdate.dart';
import 'package:meetings_manager/Screens/skypeupdate.dart';
import 'package:meetings_manager/Screens/zoomupdate.dart';
import 'package:intl/intl.dart';

import 'meetinginstaupdate.dart';

class UpdateClient extends StatefulWidget {
  final String userclient;

  const UpdateClient({Key key, this.userclient}) : super(key: key);
  @override
...
class _UpdateClientState extends State<UpdateClient> {
  ...
  _selectedTodoDate(BuildContext context) async {
    ...
    if (_pickedDate != null) {
      setState(() {
        ...
        _deadline.text = DateFormat("yyyy-MM-dd").format(_pickedDate);
      });
    }
  }
  ...
  getdata() async {
    ...
    await adddata.doc(widget.userclient).get().then((documentSnapshot) {
      name1 = documentSnapshot.data()['clientName'];
      username1 = documentSnapshot.data()['clientUserName'];
      ...
      // selectedPrior = documentSnapshot.data()['meetingPrior'];
