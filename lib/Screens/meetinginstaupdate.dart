...
class Meetinginsta extends StatefulWidget {
  final String user;

  const Meetinginsta({Key key, this.user}) : super(key: key);
  @override
  _MeetinginstaState createState() => _MeetinginstaState();
}

class _MeetinginstaState extends State<Meetinginsta> {
  String insta;
  bool meeting = false;
