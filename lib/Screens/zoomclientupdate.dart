...
class ClientZoom extends StatefulWidget {
  final String user;

  const ClientZoom({Key key, this.user}) : super(key: key);
  @override
  _ClientZoomState createState() => _ClientZoomState();
}

class _ClientZoomState extends State<ClientZoom> {
  String facebook;
  bool meeting = false;
