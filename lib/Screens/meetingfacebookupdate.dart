...
class MeetingFacebook extends StatefulWidget {
  final String user;

  const MeetingFacebook({Key key, this.user}) : super(key: key);
  @override
  _MeetingFacebookState createState() => _MeetingFacebookState();
}

class _MeetingFacebookState extends State<MeetingFacebook> {
  String facebook;
  bool meeting = false;
