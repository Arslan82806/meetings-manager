...
class Skypeupdate extends StatefulWidget {
  final String user;

  const Skypeupdate({Key key, this.user}) : super(key: key);
  @override
  _SkypeupdateState createState() => _SkypeupdateState();
}

class _SkypeupdateState extends State<Skypeupdate> {
  String skype;
  String skype1;
  bool meeting = false;
