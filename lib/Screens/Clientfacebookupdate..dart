...
class Clientfacebook extends StatefulWidget {
  final String user;

  const Clientfacebook({Key key, this.user}) : super(key: key);
  @override
  _ClientfacebookState createState() => _ClientfacebookState();
}

class _ClientfacebookState extends State<Clientfacebook> {
  String facebook;
  bool meeting = false;
