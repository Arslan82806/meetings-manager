...
class Facebookupdate extends StatefulWidget {
  final String user;

  const Facebookupdate({Key key, this.user}) : super(key: key);
  @override
  _FacebookupdateState createState() => _FacebookupdateState();
}

class _FacebookupdateState extends State<Facebookupdate> {
  String facebook;
  bool meeting = false;
